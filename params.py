...
LAMBDA_P = 1000  # Penalization for not reaching the target at time T
LAMBDA_V = 0   # Penalization for not reaching the target at time T
T = 1           # Time horizon of the problem

# Time discretization
N = 10         # Number of time steps, common for: the simulator (by default);
...
# Dynamic programming
U_L, U_R = -5, 5  # Bounds for the control
N_U = 100  # Resolution of the control
